...
#
sof2flash --input="C:/Users/Alex/Desktop/LEDTile_git_export_non_bare/output_files/LEDTile.sof" --output="../flash/LEDTile_epcs_flash_controller.flash" --epcs 
...
#
elf2flash --input="C:/Users/Alex/Desktop/LEDTile_git_export_non_bare/software/LEDTileSerialAPIApplication/LEDTileSerialAPIApplication.elf" --output="../flash/LEDTileSerialAPIApplication_epcs_flash_controller.flash" --epcs --after="../flash/LEDTile_epcs_flash_controller.flash" 
